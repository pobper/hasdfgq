...
PORT=57122
UUID=f730cd23-8bb4-49d9-b146-1b2d0eefecba
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/pobper/hasdfgq/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/pobper/hasdfgq/main/etc/xray.json
